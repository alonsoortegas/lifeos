...
create policy "owner_select_daily_checkins" on public.daily_checkins
  for select to authenticated using (is_owner());
create policy "owner_insert_daily_checkins" on public.daily_checkins
  for insert to authenticated with check (is_owner());
create policy "owner_update_daily_checkins" on public.daily_checkins
