...
create index ai_briefs_date_created_idx
  on public.ai_briefs (brief_date desc, created_at desc);
create index ai_briefs_input_hash_idx
  on public.ai_briefs (input_hash);
...
create policy "owner_select_ai_briefs" on public.ai_briefs
  for select to authenticated using (is_owner());
create policy "owner_insert_ai_briefs" on public.ai_briefs
